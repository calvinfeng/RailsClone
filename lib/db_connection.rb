...
# File.join produces file path
ROOT_FOLDER = File.join(File.dirname(__FILE__), '..')
# This is equivalent to ../cats.sql
CATS_SQL_FILE = File.join(ROOT_FOLDER, 'cats.sql')
# This is equivalent to ../cats.db
...
class DBConnection
  ...
  def self.execute2(*args)
    ...
    # However, the first row returned is always the names of the columns.
  end
